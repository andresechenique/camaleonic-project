        ...
        {topics.map((topic) => (
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row gap-2 lg:gap-12 text-right">
              ...
              >
                <DialogTrigger className="inline-block border border-2 border-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 transition">
              ...
              >
                <DialogTrigger className="inline-block border border-2 border-red-700 text-white px-6 py-3 rounded-md hover:bg-red-800 transition">
